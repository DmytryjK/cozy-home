        ...
        <footer className="footer">
            <div className="footer__bg">
                <div className="container">
                    <img src={footerLogo} alt="CozyHome" />
                    <div className="footer__list">
                        <h2 className="footer__list_title">Каталог</h2>
                        <ul className="footer__list_category">
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Крісла</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Дивани</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Столи</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Стільці</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Шафи</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Комоди</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Ліжка</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Декор</li>
                            </a>
                        </ul>
                    </div>
                    <div className="footer__list">
                        ...
                        <ul className="footer__list_category">
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Про нас</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">
                                    Доставка і оплата
                                </li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Допомога</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Сервіс</li>
                            </a>
                        </ul>
                    </div>
                    <div className="footer__list">
                        <h2 className="footer__list_title">Додатково</h2>
                        <ul className="footer__list_category">
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">Співпраця</li>
                            </a>
                            <a href="/" className="footer__list_link">
                                <li className="footer__list_text">
                                    Оптовим покупцям
                    ...
                    <div className="footer__list_contactInfo">
                        ...
                        <div className="footer__list">
                            ...
                            <ul className="footer__list_category">
                                <a
                                    href="https://www.google.com.ua/maps/place/%D1%83%D0%BB.+%D0%91%D0%BE%D0%B3%D0%B4%D0%B0%D0%BD%D0%B0+%D0%A5%D0%BC%D0%B5%D0%BB%D1%8C%D0%BD%D0%B8%D1%86%D0%BA%D0%BE%D0%B3%D0%BE,+10,+%D0%9B%D1%8C%D0%B2%D0%BE%D0%B2,+%D0%9B%D1%8C%D0%B2%D0%BE%D0%B2%D1%81%D0%BA%D0%B0%D1%8F+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C,+79000/@49.8457566,24.0268371,17z/data=!3m1!4b1!4m6!3m5!1s0x473add0d4a7c3317:0xac9b90d73878a196!8m2!3d49.8457566!4d24.029412!16s%2Fg%2F1tddwjqc?hl=ru&entry=ttu"
                    ...
                    <div className="footer__list">
                        ...
                        <ul className="footer__list_category">
                            <li className="footer__list_text">+380937241094</li>
                            <a
                        ...
                        <div className="footer__list_icons">
                            <a
                            ...
                            >
                                <div>
                                    <svg
                                        className="footer__list_icons_telegram"
                                        width="30"
                                        height="30"
                                        viewBox="0 0 30 30"
                                        fill="none"
                            ...
                            >
                                <div>
                                    <svg
                                        className="footer__list_icons_instagram"
                                        width="30"
                                        height="30"
                                        viewBox="0 0 30 30"
                                        fill="none"
                            ...
                            >
                                <div>
                                    <svg
                                        className="footer__list_icons_facebook"
                                        width="30"
                                        height="30"
                                        viewBox="0 0 30 30"
                                        fill="none"
