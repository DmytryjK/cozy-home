    ...
    return (
        ...
        >
            ...
            <a
                ...
                href="https://accounts.google.com/o/oauth2/auth?client_id=920811235941-7mhi8ad1m5qt42bumghsdvncadnj2jkf.apps.googleusercontent.com&redirect_uri=https://cozyhome-store.vercel.app/api/v1/auth/google-login&response_type=code&scope=openid profile email"
                onClick={() => {
