            ...
            >
                <div className="container">
                    <div className="information__content">
                        <h2 className="information__content_title">
                            Чому саме ми
                        </h2>
                        <p className="information__content_text">
                            Ми гарантуємо вам стильні рішення, які підкреслять
                            вашу індивідуальність та створять чудовий простір
                            для відпочинку та натхнення.
                        </p>
                    </div>
                    <div className="grid">
