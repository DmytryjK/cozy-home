            ...
            <div className="container">
                <div className="our-services__content">
                    <LazyMotion features={domAnimation} strict>
                        ...
                        >
                            Ми пропонуємо широкий вибір меблів для кожного смаку
                            і бюджету. Меблі у стилі loft - це наша сильна
                            сторона. Ми виготовляємо:
                        </m.p>
                        <m.ul
                            initial="hidden"
                            whileInView="visible"
                        ...
                        >
                            <li className="our-services__item">
                                ...
                                <div className="our-services__item-bottom">
                                    ...
                                    <p className="our-services__item-descr">
                                        Зручні ліжка, шафи, комоди і багато
                                        інших елементів для вашої спальні.
                                    </p>
                                </div>
                            </li>
                            <li className="our-services__item">
                                ...
                                <div className="our-services__item-bottom">
                                    ...
                                    <p className="our-services__item-descr">
                                        Софи, крісла, столи та тумби, які
                                        роблять вашу вітальню затишною та
                                        функціональною.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li className="our-services__item">
                                ...
                                <div className="our-services__item-bottom">
                                    ...
                                    <p className="our-services__item-descr">
                                        Безпечні та стильні меблі для вашого
                                        малюка.
                                    </p>
                                </div>
                            </li>
